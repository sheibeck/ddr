...
title: Summoner loses its offense gate; Lesser Summon sorts with level-1 spells
area: engine
resolves_phase: 75
files:
...
1. ~~"lesser summon isn't showing up in the party list when cast."~~ **WITHDRAWN by the user (2026-09-25): "the lesser summon IS showing up."** Not a bug.
