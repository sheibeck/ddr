...
- [ ] **RULES-03**: The Summoner's offense school gate is REMOVED (user, 2026-09-25: "They already have a negative of summons having a chance to turn on them"), so a level-1 Summoner can roll and cast offense spells. For the six sub-classes that keep a gate, a grimoire never holds a spell from a school gated above the hero's level. (todos 2026-09-21 summoner-rolls-freeze, 2026-09-25 summoner-loses-its-offense-gate)
