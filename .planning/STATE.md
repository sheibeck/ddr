...
- 2026-09-20 — **Average run ends floor 5–7; four-band difficulty shape** (user): Filter 1–4 (high variance) / Wall 5–8 (where the average run dies) / Breakaway 9–15 / Endgame 16–20; bot today: median death depth 3, p90 5 — too lethal early. Tuning pass after v1.6, sequenced after the cadence + initiative fixes; targets go into `docs/DIFFICULTY-RETUNE.md` — `todos/pending/2026-09-20-average-run-ends-floor-5-7-four-band-difficulty-shape.md`
...
- 2026-09-21 — **Riposte kill ends the foe turn early — remaining foes skip their swing** (user, Pixel 7 floor-13 log): `foeTurn` `break`s on a riposte kill (both hero and member sites), a hidden hero advantage also inside the bot; `continue` + a fight-over guard. Engine quick task / Ruling F engine adjustment — `todos/pending/2026-09-21-riposte-kill-ends-the-foe-turn-early-remaining-foes-skip-their-swing.md`
