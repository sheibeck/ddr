...
|---|---|---|
| Natural bot median death depth | 3 (mean 3.08) | **5–6** ("whole curve": the shallow end is eased too — with the widened early-floor levers in Levers §3; the user chose to widen rather than record a known miss) |
