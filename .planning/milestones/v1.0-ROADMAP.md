...
- [ ] **Phase 4: Mobile Presentation, Controls & Onboarding** - The game feels native and approachable on a phone, with touch controls, readable UI, and in-context teaching (10/11 — only 04-10 first-run tutorial remains, deferred by user until the UI settles)
- [x] **Phase 5: Voice, Content & Graveyard** - The game's sarcastic identity comes alive through data-driven copy tied to real events, verified safe for its rating ✓ (605/605, 2026-09-09)
- [ ] **Phase 6: Google Play Compliance & Launch** - Mazeworld is live, purchasable, and compliant on Google Play (IN PROGRESS by the user: store entry created, signed AAB on the internal-testing track with real testers 2026-09-10; production launch pending)
- [x] **Phases 7–11: Joiners / Party System** (INSERTED 2026-09-09) - Recruit an NPC joiner into a real, damageable, serialized party; the single-player foundation of the multiplayer-ready engine ✓ (code-complete + on device 2026-09-09; global retune deferred to Monster Balancing)
- [x] **Phases 12–16: Economy & Item Balancing** (INSERTED 2026-09-09) - Bags/carry, manual inventory, sell economy, inert-item wiring, conservative tuning ✓ (666/666, on device 2026-09-10; deep tuning deferred)
...
**Plans**: 10/11 plans executed (04-07/04-08 delivered via the DR loop; 04-10 tutorial deferred)
...
- [x] 04-07-PLAN.md — Engine-routing completion: combat/economy/camp/new-run through applyAction [W5] [UX-05, deferred Phase-1/3 item]
- [x] 04-08-PLAN.md — Character sheet + Oracle log + full-screen combat, dice transparency [W6] [UX-04, UX-05, UX-02]
...
- [x] 05-01-PLAN.md — Voice generator foundation: category-keyed event→copy map (all ~158 engine types, coverage-guarded), presentation-local RNG, first-pass banks + tone guide (VOX-01)
- [x] 05-02-PLAN.md — Variant breadth + narrate() wired into the live Oracle log + exhaustive family-friendly safety scan + vendored wordlist + human-review sample (VOX-01, VOX-02)
- [x] 05-03-PLAN.md — Graveyard/run-history screen: re-fetch-on-open fix + all-causes persistence round-trip + ship presentation/ to the build (VOX-03)
...
| 4. Mobile Presentation, Controls & Onboarding | 10/11 | In Progress — only 04-10 tutorial remains (user-deferred). DR13–DR18 device-review rounds complete (683/683). |  |
...
| 6. Google Play Compliance & Launch | user-driven | In progress — store entry + internal-testing track live with testers (2026-09-10); signed CLI release pipeline (2026-09-13, `docs/RELEASING.md`); production launch pending | - |
