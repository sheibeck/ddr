...
## Current State (2026-09-18, v1.5 Phase 38 complete)

**In progress:** v1.5 "Meaningful Choices" — Phases 36–38 complete (BEFORE pin, `engine/effects.js`, dead-foe retarget, Cutthroat Joiners, Company DISMISS; worn-slot model + `eff()` refactor + old-save reconciliation; melee active abilities — 11 table actives + 10 kept passives, a 20-entry rolled ability pool, `useAbility` with a named refusal ladder, Joiners using their own abilities, the combat ABILITIES submenu). Phase 38 is the first phase under the 2026-09-17 greenfield ruling (no dual-path code; 20 declared, measured fixture divergences). 2563 tests green; parity master untouched; 47 Pixel 7 checks deferred to the milestone-close batch. Next: Phase 39 (gear, magic items & one-shot tools — no research).
...
---
*Last updated: 2026-09-18 after Phase 38 (v1.5 Melee Active Abilities)*
