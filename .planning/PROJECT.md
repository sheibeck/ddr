...
## Current State (2026-09-17, v1.5 Phase 36 complete)

**In progress:** v1.5 "Meaningful Choices" — Phase 36 complete (v1.5 BEFORE class-matrix pin at `e69ff07` in `docs/class-pass/v15-before*.json`; `engine/effects.js` timer foundation with zero records; dead-foe auto-retarget; Cutthroat Joiners with the 1-in-20 murder risk; Company-panel sheet + two-tap DISMISS). 2276 tests green; parity master untouched; 18 Pixel 7 checks deferred to the milestone-close batch. Next: Phase 37 (worn-slot model + eff() refactor).
...
---
*Last updated: 2026-09-17 after Phase 36 (v1.5 Balance Foundation, Effect Timers & Small Independent Wins)*
