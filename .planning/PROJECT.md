...
- [~] **Combat narrative & input redesign** — v1.3: Phase 30 survey done and the Round Card ratified (`docs/COMBAT-NARRATIVE-DESIGN.md`, Key Decision recorded 2026-09-16); Phase 32 builds it from the §6 contract (one always-visible round block, ≤1 tap to move on, 250 ms arm-delay/dismiss-settle guards, Oracle unchanged)
...
---
*Last updated: 2026-09-16 — after Phase 31 (Combat Start Gating & Effect Hygiene; Afraid penalty + Elven flip recorded)*
