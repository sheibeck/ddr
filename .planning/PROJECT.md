...
## Current State (2026-09-17, v1.5 Phase 37 complete)

**In progress:** v1.5 "Meaningful Choices" — Phases 36–37 complete (BEFORE pin, `engine/effects.js`, dead-foe retarget, Cutthroat Joiners, Company DISMISS; worn-slot model + `eff()` refactor + old-save reconciliation). 2388 tests green; parity master untouched; 32 Pixel 7 checks deferred to the milestone-close batch. Next: Phase 38 (melee active abilities — researched).
...
---
*Last updated: 2026-09-17 after Phase 37 (v1.5 Equipment Slot Model & eff() Refactor)*
