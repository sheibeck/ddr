...
import { ITEM_STATE_COPY, ABILITY_VIEW_COPY } from "../../src/browser/viewModels.js";
...
test("Presentation COPY objects: every string leaf is free of a standalone wp/WP token", () => {
  const banks = {
    RAIL_COPY, ITEM_STATE_COPY, ABILITY_VIEW_COPY, COMBAT_MENU_COPY, COMBAT_PANEL_COPY, MISS_LINES,
  };
  const offenders = [];
