...
**Build:** Play build: 2.0.0 (versionCode 10), `android/app/build/outputs/bundle/release/app-release.aab`, 12,740,741 bytes, sha256 `732b96a68abf55a4e43ccb5ef75fe89056cc56f0faf0d93210667c752f9ec214`, signed with the upload key (certificate SHA-256 `50:45:7F:A3:B8:D5:5F:D0:EF:89:C5:74:BF:40:B3:F3:02:9F:EC:C4:9F:50:C5:1D:86:B1:AF:DD:5E:02:56:DD`), built on 2026-09-24 from the release commit tagged `v2.0.0-play10`. It carries Phases 65–71, quick 260924-g8m, the user's re-recorded walk1–3 clips, the live APP_ID 517177834262 and the five Season-1 board IDs. The user uploads it by hand (row 0.3). It supersedes 2.0.0 (versionCode 9, tag `v2.0.0-play9`, before Phases 70–71, with the placeholder IDs). The milestone's debug APK is recorded here by the orchestrator at the close (D-08). **Debug APK (Phases 65–71 + the live Play Games IDs):** `android/app/build/outputs/apk/debug/app-debug.apk`, 14,918,432 bytes, sha256 `7ed8115b440cb00d0695bf4be2b96ee94cc2529b600571cd9728b44060df1809`, built from master `65c1a6f` (Phase 71 + quick 260924-g8m) on 2026-09-24 and installed on the Pixel 7 with `adb install -r` (same debug signer, so the save is kept). It carries the live APP_ID 517177834262 and the five Season-1 board IDs (quick 260924-c14); sign-in on it needs the debug-keystore credential (row 0.10). Sections L and M are walked on this build.
